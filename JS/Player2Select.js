Game.Player2Select = function(game){};
...
Game.Player2Select.prototype = {
//create function
    create:function(game){
        //create menu
        var s = game.add.sprite(0, 0, 'menu1');

        this.createtitle(game,"Player 2 Ship Selector",400, 130, function(){
            menu_music.stop();
        ...
        this.createButton1(game,"",190, 360, 200, 150, function(){
            ShipClass = 1;
            sessionStorage.setItem("ShipClass2", ShipClass);
            this.state.start('JS/LevelMenu');
...
//createButton1 function
    createButton1:function(game,string,x,y,w,h,callback){
        ...
        var button1 = game.add.button(x, y, 'SloopBtn2', callback, this, 2, 1, 0);
...
//createButton2 function
    createButton2:function(game,string,x,y,w,h,callback){
        var button2 = game.add.button(x, y, 'CaravelBtn2', callback, this, 2, 1, 0);
...
//createButton3 function
    createButton3:function(game,string,x,y,w,h,callback){
        var button3 = game.add.button(x, y, 'BarrackBtn2', callback, this, 2, 1, 0);
    ...
    createButton4:function(game,string,x,y,w,h,callback){
        var button4 = game.add.button(x, y, 'BrigantineBtn2', callback, this, 2, 1, 0);
...
//createtitle function
    ...
    createButton5:function(game,string,x,y,w,h,callback){
        var button5 = game.add.button(x, y, 'FrigateBtn2', callback, this, 2, 1, 0);
    ...
    createButton6:function(game,string,x,y,w,h,callback){
        var button6 = game.add.button(x, y, 'ManOWarBtn2', callback, this, 2, 1, 0);
