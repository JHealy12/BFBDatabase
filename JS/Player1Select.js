Game.Player1Select = function(game){};
...
Game.Player1Select.prototype = {
//create function
    create:function(game){
        //create menu
        var s = game.add.sprite(0, 0, 'menu1');

        this.createtitle(game,"Player 1 Ship Selector",400, 130, function(){
            menu_music.stop();
        ...
        this.createButton1(game,"",190, 360, 200, 150, function(){
            ...
            this.state.start('JS/Player2Select');
