...
function preload () {
    ...
    game.load.atlas('ship', 'assets/ship.png', 'assets/ships.json');
    game.load.atlas('enemy', 'assets/enemy-ship.png', 'assets/ships.json');
...
//map
		...
		map.setCollisionBetween(19, 45);
		 ...
		 scoreText = this.add.text(550, 10, "Score: " + Score);
