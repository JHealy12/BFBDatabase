Game.Level_3 = function(game){};
//create variables for level2
	var map;
	var score;
	...
	var startPlayery = 350;
	var startPlayer2x = 700;
	var startPlayer2y = 350;
	var cursors;
	var bullet;
	var weapon;
	var weapon2;
...
//create function
	...
	//create player
        ...
        if(ShipClass1 == 1)
        {
            player = this.add.sprite(150, 350, 'Sloop');
        ...
        {
            player = this.add.sprite(150, 350, 'Caravel');
            player.anchor.set(0.5, 0.5);
            player.angle = 45;
            p1HealthText = this.add.text(50, 350, "Player 1: " + health1 + "%");
        }
        else if(ShipClass1 == 3)
        {
            player = this.add.sprite(150, 350, 'Barrack');
            player.anchor.set(0.5, 0.5);
            player.angle = 45;
            p1HealthText = this.add.text(50, 10, "Player 1: " + health1 + "%");
        }
        ...
        {
            player = this.add.sprite(150, 350, 'Brigantine');
            player.anchor.set(0.5, 0.5);
            player.angle = 45;
            p1HealthText = this.add.text(50, 10, "Player 1: " + health1 + "%");
        }
        ...
        {
            player = this.add.sprite(150, 350, 'Frigate');
            player.anchor.set(0.5, 0.5);
            player.angle = 45;
            p1HealthText = this.add.text(50, 10, "Player 1: " + health1 + "%");
        }
        ...
        {
            player = this.add.sprite(150, 350, 'ManOWar');
            player.anchor.set(0.5, 0.5);
            player.angle = 45;
            p1HealthText = this.add.text(50, 10, "Player 1: " + health1 + "%");
        }
	//create player2
        ...
        if (ShipClass2 == 1)
        {
            player2 = this.add.sprite(700, 350, 'Sloop');
        ...
        {
            player2 = this.add.sprite(700, 350, 'Caravel');
            player2.anchor.set(0.5, 0.5);
            player2.angle = 230;
            p2HealthText = this.add.text(550, 10, "Player 2: " + health2 + "%");
        }
        ...
        {
            player2 = this.add.sprite(700, 350, 'Barrack');
            player2.anchor.set(0.5, 0.5);
            player2.angle = 230;
            p2HealthText = this.add.text(550, 10, "Player 2: " + health2 + "%");
        }
        ...
        {
            player2 = this.add.sprite(700, 350, 'Brigantine');
            player2.anchor.set(0.5, 0.5);
            player2.angle = 230;
            p2HealthText = this.add.text(550, 10, "Player 2: " + health2 + "%");
        }
        ...
        {
            player2 = this.add.sprite(700, 350, 'Frigate');
            player2.anchor.set(0.5, 0.5);
            player2.angle = 230;
            p2HealthText = this.add.text(550, 10, "Player 2: " + health2 + "%");
        }
        ...
        {
            player2 = this.add.sprite(700, 350, 'ManOWar');
            player2.anchor.set(0.5, 0.5);
            player2.angle = 230;
            p2HealthText = this.add.text(550, 10, "Player 2: " + health2 + "%");
        }
...
//playerCollisions function
	playerCollisions: function(p,w){
		...
		if (health1 == 0)
		{
            p.reset(150, 350); //reset player to starting location
			p1Lives -= 1;
			health1 = 100;
        }
        else if (health1 > 0)
...
//player2Collisions function
	player2Collisions: function(p){
		...
		if (health2 == 0)
		{
            p.reset(700, 350); //reset player2 to starting location
			p2Lives -=1;
			health2 = 100;
        }
        else if(health2 >= 0)
